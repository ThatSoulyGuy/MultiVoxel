...
namespace std
{
	template <MultiVoxel::Independent::Math::Arithmetic T, size_t N>
	struct hash<MultiVoxel::Independent::Math::Vector<T, N>>
	{
		size_t operator()(const MultiVoxel::Independent::Math::Vector<T, N>& input) const
		{
			size_t hashValue = 0;
	...
	template <MultiVoxel::Independent::Math::Arithmetic T, size_t N>
	struct formatter<MultiVoxel::Independent::Math::Vector<T, N>> : formatter<T>
	{
		template <typename FormatContext>
		auto format(const MultiVoxel::Independent::Math::Vector<T, N>& input, FormatContext& context)
		{
